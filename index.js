...
performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */, data, validator, grammar) {
/* this == yyval */
...
break;
case 2:
this.$ = !grammar ? ($$[$0-2] || $$[$0]) : [$$[$0-2], 'or', $$[$0]];
break;
case 3:
this.$ = !grammar ? ($$[$0-2] && $$[$0]) : [$$[$0-2], 'and', $$[$0]];
break;
case 4:
this.$ = !grammar ? !$$[$0] : [$$[$0], 'not', null];
break;
case 5:
this.$ = !grammar ? ($$[$0-2] === $$[$0]) : [$$[$0-2], 'eq', $$[$0]];
break;
case 6:
this.$ = !grammar ? ($$[$0-2] !== $$[$0]) : [$$[$0-2], 'neq', $$[$0]];
break;
case 7:
this.$ = validator ? validator.in($$[$0-2], $$[$0]) : (!grammar ? ($$[$0].indexOf($$[$0-2]) !== -1) : [$$[$0-2], 'in', $$[$0]])
break;
case 8:
this.$ = validator ? validator.not_in($$[$0-2], $$[$0]) : (!grammar ? ($$[$0].indexOf($$[$0-2]) === -1) : [$$[$0-2], 'nin', $$[$0]])
break;
case 9:
this.$ = !grammar ? $$[$0-2] > $$[$0] : [$$[$0-2], 'gt', $$[$0]];
break;
case 10:
this.$ = !grammar ? $$[$0-2] >= $$[$0] : [$$[$0-2], 'gte', $$[$0]];
break;
case 11:
this.$ = !grammar ? $$[$0-2] < $$[$0] : [$$[$0-2], 'lt', $$[$0]];
break;
case 12:
this.$ = !grammar ? $$[$0-2] <= $$[$0] : [$$[$0-2], 'lte', $$[$0]];
break;
case 13:
this.$ = $$[$0-1];
break;
...
break;
case 15:
this.$ = validator ? validator.variable(yytext, data) : !grammar ? data[yytext]: yytext;
break;
case 16:
